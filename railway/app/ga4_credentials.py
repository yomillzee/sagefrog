...
def validate_and_encode_service_account(raw_json: str) -> tuple[str, str]:
    ...
    The base64 is the form GLOBAL_GCP_CREDENTIALS_ENV accepts. Raises RuntimeError
    if the payload is not a Google service account key. Never logs the key material.
    """
