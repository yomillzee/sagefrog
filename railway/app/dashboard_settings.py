    ...
    *,
    ...
    if db_editable:
        ...
        <section class="panel">
          ...
          <p class="muted">OAuth tokens stay in Railway env vars. Map this client to the correct ad accounts and GA4 property.</p>
          {meta}
    ...
    <section class="panel muted-panel">
      <h2>Connect OAuth &amp; API credentials</h2>
      <p>Platform OAuth tokens and API keys are configured in <strong>Railway environment variables</strong>, not in this UI (secrets never appear in the browser).</p>
      <ul class="checklist">
        <li><strong>Google Ads:</strong> GOOGLE_ADS_DEVELOPER_TOKEN, GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_REFRESH_TOKEN</li>
        <li><strong>LinkedIn:</strong> LINKEDIN_CLIENT_ID, LINKEDIN_CLIENT_SECRET, LINKEDIN_REFRESH_TOKEN</li>
        <li><strong>Meta:</strong> META_APP_ID, META_APP_SECRET, META_ACCESS_TOKEN, META_BUSINESS_ID</li>
        <li><strong>GA4:</strong> GCP_SERVICE_ACCOUNT_JSON, GA4_CLIENTS, BQ_PROJECT_ID, BQ_DATASET_ID</li>
        <li><strong>Auth:</strong> DATABASE_URL, AUTH_SESSION_SECRET, API_KEY, AUTH_BOOTSTRAP_ADMIN_*</li>
      </ul>
      <p class="muted">After updating Railway vars, redeploy and use “Test all connections” below.</p>
    </section>
    """
